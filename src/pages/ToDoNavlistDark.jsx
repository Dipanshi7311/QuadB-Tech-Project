import './ToDoNavlistDark.css'
import { Link } from 'react-router-dom'

export default function ToDoNavlistDark() {
  return (
    <div className="to-do-navlist-dark">
      <div className="web-app-nav-bar">
        <div className="container-2">
          <div className="menu">
          <Link to="/ToDolistDark"><img className="icon" src="assets/vectors/Icon95_x2.svg" /></Link>
          </div>
          <div className="logo">
            <div className="logomark">
              <img className="union" src="assets/vectors/Union11_x2.svg" />
            </div>
            <div className="do-it">
            DoIt
            </div>
        ...
        <div className="header">
          <div className="search">
            <img className="icon-1" src="assets/vectors/Icon52_x2.svg" />
          </div>
          <div className="app-grid">
            <Link to="/ToDoNavblockDark"><img className="icon-2" src="assets/vectors/Icon30_x2.svg" /></Link>
          </div>
          <div className="phsun">
            <Link to="/ToDoNavlistLight"><img className="vector" src="assets/vectors/Vector88_x2.svg" /></Link>
          </div>
        </div>
      </div>
              ...
              <div className="side-panel-menu">
                ...
                <div className="menu-item-1">
                  <div className="calendar">
                    <img className="icon-3" src="assets/vectors/Icon67_x2.svg" />
                  </div>
                ...
                <div className="menu-item-2">
                  <div className="clock">
                    <img className="vector-3" src="assets/vectors/Vector77_x2.svg" />
                  </div>
                ...
                <div className="menu-item-3">
                  <div className="clock-1">
                    <img className="vector-4" src="assets/vectors/Vector123_x2.svg" />
                  </div>
                ...
                <div className="menu-item-4">
                  <div className="clock-2">
                    <img className="group-1" src="assets/vectors/Group10_x2.svg" />
                  </div>
              ...
              <div className="side-panel-menu-1">
                <div className="menu-item-5">
                  <div className="menu-2">
                    <img className="vector-8" src="assets/vectors/Vector100_x2.svg" />
                  </div>
            ...
            <div className="sidebar-2">
              <div className="side-panel-menu-2">
                ...
                <div className="container-1">
                  ...
                  <img className="container-7" src="assets/vectors/Container4_x2.svg" />
          ...
          <div className="table">
            <div className="title">
              ...
              <div className="caret-down">
                <img className="icon-4" src="assets/vectors/Icon11_x2.svg" />
              </div>
            </div>
            <div className="text-cell">
              ...
              <div className="frame-2">
                <div className="container-5">
                  <img className="claritynotification-line" src="assets/vectors/ClaritynotificationLine5_x2.svg" />
                  <div className="birepeat">
                    <img className="vector-11" src="assets/vectors/Vector91_x2.svg" />
                  </div>
                  <div className="iconoircalendar">
                    <img className="vector-12" src="assets/vectors/Vector22_x2.svg" />
                  </div>
                </div>
            ...
            <div className="text-cell-1">
              ...
              <div className="phstar">
                <img className="vector-13" src="assets/vectors/Vector135_x2.svg" />
              </div>
            </div>
            <div className="text-cell-2">
              ...
              <div className="phstar-1">
                <img className="vector-14" src="assets/vectors/Vector90_x2.svg" />
              </div>
            </div>
            <div className="text-cell-3">
              ...
              <div className="phstar-2">
                <img className="vector-15" src="assets/vectors/Vector170_x2.svg" />
              </div>
            </div>
            <div className="text-cell-4">
              ...
              <div className="phstar-3">
                <img className="vector-16" src="assets/vectors/Vector106_x2.svg" />
              </div>
            </div>
            <div className="text-cell-5">
              ...
              <div className="phstar-4">
                <img className="vector-17" src="assets/vectors/Vector107_x2.svg" />
              </div>
            </div>
            ...
            <div className="frame-9">
              <div className="text-cell-6">
                <div className="frame-10">
                  <div className="checkboxes-5">
                    <div className="check-small">
                      <img className="icon-5" src="assets/vectors/Icon94_x2.svg" />
                    </div>
                  </div>
                ...
                <div className="phstar-5">
                  <img className="vector-18" src="assets/vectors/Vector45_x2.svg" />
                </div>
              </div>
              <div className="text-cell-7">
                <div className="frame-11">
                  <div className="checkboxes-6">
                    <div className="check-small-1">
                      <img className="icon-6" src="assets/vectors/Icon45_x2.svg" />
                    </div>
                  </div>
                ...
                <div className="phstar-6">
                  <img className="vector-19" src="assets/vectors/Vector161_x2.svg" />
                </div>
              </div>
              <div className="text-cell-8">
                <div className="frame-12">
                  <div className="checkboxes-7">
                    <div className="check-small-2">
                      <img className="icon-7" src="assets/vectors/Icon8_x2.svg" />
                    </div>
                  </div>
                ...
                <div className="phstar-7">
                  <img className="vector-20" src="assets/vectors/Vector171_x2.svg" />
                </div>
              </div>
              <div className="text-cell-9">
                <div className="frame-13">
                  <div className="checkboxes-8">
                    <div className="check-small-3">
                      <img className="icon-8" src="assets/vectors/Icon56_x2.svg" />
                    </div>
                  </div>
                ...
                <div className="phstar-8">
                  <img className="vector-21" src="assets/vectors/Vector165_x2.svg" />
                </div>
              </div>
            </div>
          </div>
